...
// impl ExcelFile {
//     pub fn new(content: Vec<u8>) -> Result<Self, Box<dyn std::error::Error>> {
//         let cursor = Cursor::new(content.clone());
//         let workbook = Xlsx::new(cursor)?;
//         Ok(Self { content, workbook })
//     }

//     pub fn display_basic_info(&mut self) -> Result<(), Box<dyn std::error::Error>> {
...
//                                 else if cell.is_int() { "Integer" }
//                                 else if cell.is_float() { "Float" }
//                                 else if cell.is_string() { "String" }
//                                 else if cell.is_bool() { "Boolean" }
//                                 else if cell.is_error() { "Error" }
//                                 else { "Unknown" }
//                             })
//                             .collect();
